 ...
 * Description
 * @export
 * @class TheophileReference
 */
export default class TheophileReference {
	static loaded = false;
	static plugins = {};
	static hooks = {
		beforeCreate: [],
	...
	static async exec(root) {
		this.trace("TheophileReference BEGIN");
		...
		this.trace("TheophileReference END");
	}
	/**
	 * Description
	 * @param {string} [root="."]
	 * @returns Promise
	 * @memberof TheophileReference
	 */
